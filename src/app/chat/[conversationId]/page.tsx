    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-black">
        <div className="text-center">
          ...
          <p className="text-[#b0b3b8] text-[15px]">Descifrando conversación...</p>
        </div>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="w-[360px] bg-black border-r border-[#2f3031] flex flex-col">
        <div className="p-4 pt-5 pb-2">
          ...
          <h2 className="text-[#e4e6eb] text-2xl font-bold">Chats</h2>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col bg-black">
        ...
        <div className="px-4 py-3 bg-black border-b border-[#2f3031] flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[#e4e6eb] font-semibold text-[15px] truncate">{otherUsername}</p>
            <div className="flex items-center gap-1 text-emerald-500 text-[13px] truncate">
          ...
          <button
            ...
            className="p-2 rounded-full hover:bg-[#3a3b3c] text-[#0084ff] transition-colors"
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-1 bg-black">
          {messages.length === 0 && (
            <div className="text-center text-[#b0b3b8] py-12">
              ...
              <p className="text-[15px] font-medium text-[#e4e6eb]">Mensajes y llamadas cifradas de extremo a extremo</p>
                ...
                <div
                  className={`max-w-[75%] px-4 py-2 ${
                    isMe
                      ...
                      : 'bg-[#242526] text-[#e4e6eb] rounded-[20px] ' + (isLastInGroup ? 'rounded-bl-[4px]' : '')
                  }`}
        ...
        <div className="p-3 bg-black">
          <div className="flex items-end gap-2">
            <button className="p-2 text-[#0084ff] hover:bg-[#3a3b3c] rounded-full transition-colors flex-shrink-0">
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                 <line x1="12" y1="5" x2="12" y2="19"></line>
                 <line x1="5" y1="12" x2="19" y2="12"></line>
               </svg>
            </button>
            <div className="flex-1 bg-[#3a3b3c] rounded-3xl flex items-center pr-2">
              <input
                type="text"
                value={newMessage}
                ...
                placeholder="Aa"
                className="flex-1 px-4 py-2 bg-transparent text-[#e4e6eb] placeholder-[#b0b3b8] focus:outline-none text-[15px]"
                disabled={sending}
              />
              <button className="p-2 text-[#0084ff] hover:bg-[#4e4f50] rounded-full transition-colors flex-shrink-0">
                 <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {newMessage.trim() ? (
              <button
                onClick={sendMessage}
                disabled={sending}
                className="p-2 text-[#0084ff] hover:bg-[#3a3b3c] rounded-full transition-colors flex-shrink-0"
              >
                {sending ? (
