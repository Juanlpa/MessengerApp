...
export default function ChatPage() {
  ...
  return (
    <div className="flex w-full">
      {/* Sidebar */}
      <div className="w-[360px] bg-black border-r border-[#2f3031] flex flex-col">
        {/* Header */}
        <div className="p-4 pt-5 pb-2">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-bold text-[#e4e6eb]">Chats</h1>
          ...
          <div className="relative mb-2">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
               <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#b0b3b8" strokeWidth="2">
            ...
            <input 
              ...
              className="w-full bg-[#3a3b3c] text-[#e4e6eb] placeholder-[#b0b3b8] rounded-full py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-[#0084ff]/50 text-[15px]"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-2">
          {conversations.length === 0 ? (
            <div className="p-8 text-center text-[#b0b3b8] text-[15px]">
            ...
            conversations.map(conv => (
              <Link
                key={conv.id}
                href={`/chat/${conv.id}`}
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#242526] transition-colors mb-1"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[#e4e6eb] text-[15px] font-medium truncate">
                    {conv.otherUser.username}
                  </p>
                  <p className="text-[#b0b3b8] text-[13px] truncate">
                    {conv.lastMessageAt
      ...
      <div className="flex-1 flex items-center justify-center bg-black">
        <div className="text-center text-[#b0b3b8]">
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="mx-auto mb-4 text-[#3a3b3c]">
      ...
      {showNewChat && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-[#242526] rounded-xl border border-[#3a3b3c] w-full max-w-md p-6 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-[20px] font-bold text-[#e4e6eb]">Nuevo Chat</h2>
              <button
            ...
            <div className="flex gap-2 mb-4">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-full bg-[#3a3b3c] border border-transparent text-[#e4e6eb] placeholder-[#b0b3b8] focus:outline-none focus:border-[#0084ff] text-[15px]"
              />
              <button
                onClick={searchUsers}
            ...
            <div className="max-h-60 overflow-y-auto space-y-2">
              {searchResults.map(u => (
                <button
                  ...
                  disabled={creating}
                  className="w-full flex items-center gap-3 p-2 rounded-lg hover:bg-[#3a3b3c] transition-colors text-left disabled:opacity-50"
                >
                  ...
                  <div className="flex-1">
                    <p className="text-[#e4e6eb] text-[15px] font-medium">{u.username}</p>
