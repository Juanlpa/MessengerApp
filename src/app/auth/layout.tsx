    ...
    <div className="min-h-screen bg-[#f0f2f5] dark:bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-[396px]">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-[28px] leading-8 font-normal text-[#1c1e21] dark:text-white">Messenger</h1>
        </div>

        {/* Card */}
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-[0_2px_4px_rgba(0,0,0,0.1),0_8px_16px_rgba(0,0,0,0.1)] dark:shadow-[0_2px_4px_rgba(0,0,0,0.5),0_8px_16px_rgba(0,0,0,0.5)] p-5">
          {children}
        </div>
      </div>
    </div>
